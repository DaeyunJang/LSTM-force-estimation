...
# 시계열 학습 모델 폴더 (너가 지정)
model_dir = os.path.join('..', 'fit', 'fit_LSTM_timeseries_MSE_offset',
                         '20260115-194159')
save_dir = os.path.join('..', 'results', 'results_LSTM_timeseries_MSE_offset', time_now)
...
print("Loaded model:", os.path.join(model_dir, 'lstm_model.h5'))
