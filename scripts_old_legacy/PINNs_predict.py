...
model_dir = os.path.join('..', 'fit', 'fit_PINNs', '20260115-094203')
save_dir = os.path.join('..', 'results', 'results_PINNs')
save_dir = os.path.join(save_dir, time_now)
if not os.path.exists(save_dir):
    os.makedirs(save_dir)

# 모델 불러오기
model = tf.keras.models.load_model(os.path.join(model_dir, 'PINNs_model.h5'))
